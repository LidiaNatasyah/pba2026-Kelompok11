...
==========================================
Membersihkan teks sentimen e-commerce bahasa Indonesia:
lowercase → hapus URL/HTML → hapus non-alpha → normalisasi slang → strip.
"""
...
# ──────────────────────────────────────────────
# Bisa ditambahkan lagi sesuai kebutuhan teks e-commerce
SLANG_MAP = {
    "yg": "yang",
    "bgt": "banget",
    "bgtt": "banget",
...
def clean_text(text: str) -> str:
    """
    Membersihkan satu string teks berbahasa Indonesia.
    ...
    5. Normalisasi kata slang/singkatan
...
def load_and_clean(
    ...
    Returns:
        ...
        - 'label_encoded' : label numerik (0–2)
    """
    ...
    if TEXT_COL not in df.columns or LABEL_COL not in df.columns:
        raise ValueError(f"Kolom {TEXT_COL} atau {LABEL_COL} tidak ditemukan di dataset.")
